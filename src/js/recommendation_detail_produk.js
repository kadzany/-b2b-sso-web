...
function tutupLihatBarang(){
    window.location = "recommendation_katalog_produk.html";
}        
...
function rekomendasikanBarang(){
    $(document).ready(function () {
        function onClose (){
            return;
        }

        $("#recommendWindow").kendoWindow({
            width: "600px",
            title: "Produk berhasil dipilih sebagai rekomendasi.",
            visible: false,
            actions: [
                "Close"
            ],
